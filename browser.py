...
class Browser:
    def __init__(self):
        ...
        self.pepper_ignore_changes = False
        self.pepper_tabs = 0
        self.pepper_last_completion = ""
        self.pepper_last_completion_orig = ""
